...
export const areas: Area[] = [
  ...
  },
  {
    ...
    body: 'Anything I make with my hands or my head lands here first. Projects split off when they get an end date.\n\nThe rule for subareas: only when the same kind of thing keeps showing up.',
    parentAreaId: null,
    emblem: 'layers',
  },
  {
  ...
  // A title near the contract's 200-character limit, so long names are reviewable everywhere
  // a title is drawn rather than only where a short one happens to fit.
  {
    id: 'reading',
    name: 'Reading, research, and the articles I keep meaning to write up before I forget why they mattered',
    description: 'Long-form input, kept until it turns into something.',
    body: '',
    parentAreaId: null,
    emblem: 'layers',
  },
...
export const projects: Project[] = [
  {
    ...
    body: '## Why\n\nA second brain that agents can read and write, organised as actionable notes rather than a pile of resources.\n\n## Current shape\n\n- Server owns the hierarchy\n- Mobile and CLI speak the same contracts\n- Everything is a note with a place',
  ...
  },
  {
    ...
    body: 'Two weeks in spring. Kyoto for the first half, then wherever the trains go.',
    areaId: 'personal',
    emblem: 'arch',
  },
  {
